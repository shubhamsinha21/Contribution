        ...
        <KeyboardAvoidingView behavior='padding' keyboardVerticalOffset={100}>
            <View style={styles.container}>
                <View style={styles.form}>
                    <Text style={styles.header}> <Text style={styles.head}>Login Here</Text></Text>
                    ...
                    <View style={styles.loginPage}>
                        ...
                        <TouchableOpacity onPress={() => navigation.navigate('ResetPassword')}><Text style={styles.login}>Forgot Passord</Text></TouchableOpacity>
                    </View>
